...
export declare type PersistOptions<S, PersistedState = S> = {
...
declare type Persist = <T extends State, Mps extends [StoreMutatorIdentifier, unknown][] = [], Mcs extends [StoreMutatorIdentifier, unknown][] = [], U = Partial<T>>(initializer: StateCreator<T, [...Mps, ['zustand/persist', unknown]], Mcs>, options?: PersistOptions<T, U>) => StateCreator<T, Mps, [['zustand/persist', U], ...Mcs]>;
